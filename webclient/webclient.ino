...
#define ESP_SSID "ZTE_24F54B" // Your network name here
#define ESP_PASS "91275731" // Your network password here
...
void setup() {
  ...
  // This might work with other firmware versions (no guarantees)PASSWORD
